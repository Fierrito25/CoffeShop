    ...
    <main class="form-login m-auto pt-4" style="max-width: 350px;">
        ...
        <form class="row g-3" action="login.php" method="post" autocomplete="off">
            ...
            <div class="form-floating">
                <input class="form-control" type="text" name="usuario" id="usuario" placeholder="Usuario" value="" requireda>
                <label for="usuario">Usuario</label>
            </div>

            <div class="form-floating">
                <input class="form-control" type="password" name="password" id="password" placeholder="Contraseña" value="" requireda>
